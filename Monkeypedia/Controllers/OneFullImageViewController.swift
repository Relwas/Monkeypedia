...
class OneFullImageViewController: UIViewController {
    ...
    let saveButtonBackgroundView: UIView = {
        let view = UIView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.backgroundColor = .gray // Set your desired background color for saveButton
        view.layer.cornerRadius = 25
        view.clipsToBounds = true
        return view
    }()

    let favoriteButtonBackgroundView: UIView = {
        let view = UIView()
        view.translatesAutoresizingMaskIntoConstraints = false
        view.backgroundColor = .gray // Set your desired background color for favoriteButton
        view.layer.cornerRadius = 25
        view.clipsToBounds = true
        return view
    }()
    ...
    let saveButton: UIButton = {
        ...
        button.setImage(UIImage(systemName: "square.and.arrow.down.fill")?.withTintColor(.black), for: .normal)
    ...
    let favoriteButton: UIButton = {
        ...
        button.translatesAutoresizingMaskIntoConstraints = false
        button.setImage(UIImage(systemName: "heart.fill")?.withTintColor(.black), for: .normal)
        button.imageEdgeInsets = UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 15)
